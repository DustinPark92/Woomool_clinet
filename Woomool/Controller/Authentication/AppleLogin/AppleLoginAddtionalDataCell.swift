//
//  AppleLoginAddtionalDataCell.swift
//  Woomool
//
//  Created by Dustin on 2021/01/07.
...
class AppleLoginAddtionalDataCell: UITableViewCell {
    
    
    lazy var emailContainer = Utilites().inputContainerView(textField: emailTextField, description: "이메일", requiredText: "*",warningLabel: emailWarningLabel,warningColor: .red)
    let emailTextField = Utilites().textField(placeholder: "woomool@woomool.kr")
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        emailContainer.anchor(top:genderContainer.bottomAnchor,left: leftAnchor,right: rightAnchor,paddingTop: 48,paddingLeft: 16,paddingRight: 16,height: 90)
        emailWarningLabel.font = UIFont.NotoMedium12
        emailWarningLabel.textColor = .gray350
        emailWarningLabel.text = "비밀번호 찾기를 위해 수신 가능한 이메일을 입력해주세요."
        
        contentView.addSubview(inviteCodeContainer)
        inviteCodeContainer.anchor(top:emailContainer.bottomAnchor,left: leftAnchor,right: rightAnchor,paddingTop:48 ,paddingLeft: 16,paddingRight:16 ,height: 90)
