//
//  AppleLoginAdditionalDataVC.swift
//  Woomool
//
...
class AppleLoginAdditionalDataVC: UIViewController {
    ...
    func configureUI() {
        ...
        tableView.register(AppleLoginAddtionalDataCell.self, forCellReuseIdentifier: "AppleLoginAddtionalDataCell")
    ...
    @objc func handleNext() {
        ...
        print("데이터는? \(viewModel.addtionalDataContents)")
...
extension AppleLoginAdditionalDataVC : UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return 1
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "AppleLoginAddtionalDataCell", for: indexPath) as! AppleLoginAddtionalDataCell
...
extension AppleLoginAdditionalDataVC : UITextFieldDelegate {
    ...
    func textFieldDidChangeSelection(_ textField: UITextField) {
        ...
        case 2:
            if text.isValidEmailAddress(email: text) {
                ...
                viewModel.addtionalDataContents.remove(at: 3)
                viewModel.addtionalDataContents.insert(text, at: 3)
            } else {
