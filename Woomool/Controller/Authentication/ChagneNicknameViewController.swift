//
//  ChagneNicknameViewController.swift
//  Woomool
//
...
class ChagneNicknameViewController: UITableViewController {
        ...
        func configureUI() {
            ...
            ViewModel.subjectList.insert("닉네임", at: 0)
            ViewModel.placeholderList.remove(at: 0)
            ViewModel.placeholderList.insert("부적절한 단어는 사용에 제한을 받습니다.", at: 0)
    ...
    extension ChagneNicknameViewController : UITextFieldDelegate  {
