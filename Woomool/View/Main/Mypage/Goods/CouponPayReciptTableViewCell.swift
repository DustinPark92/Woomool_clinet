...
class CouponPayReciptTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        priceTitle.anchor(top:mainLabel.bottomAnchor,left: leftAnchor,paddingTop:14 ,paddingLeft:14)
        priceLabel.anchor(top:mainLabel.bottomAnchor,right: rightAnchor,paddingTop:10 ,paddingRight:17,height: 30)
        dotSv.anchor(top:priceTitle.bottomAnchor,left: leftAnchor,right: rightAnchor,paddingTop:14 ,paddingLeft:16,paddingRight: 16,width: 300,height: 1)
        ...
        dotSv2.anchor(top:discountLabel.bottomAnchor,left: leftAnchor,right: rightAnchor,paddingTop:14 ,paddingLeft:16,paddingRight: 16,width: 300,height: 1)
        ...
        sv.anchor(top:usingCountLabel.bottomAnchor,left: leftAnchor,right: rightAnchor,paddingTop:14 ,paddingLeft:16,paddingRight: 16, height: 2)
